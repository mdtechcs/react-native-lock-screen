...
let checkedSVG =
  '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65.36 53.45"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M.66,28.71l6-7,15,16,36-37,7,7-43,45Z" fill="#747474" stroke="#747474" stroke-miterlimit="10"/></g></g></svg>';
let backspaceSVG =
    ...
    if (value === 10) {
      ...
      if (!alphabetPinSuggestion) {
        ...
        pin = (
          ...
          >
            <View>
              <Text style={[style.pin, textStyle]}>{this.props.value}</Text>
            </View>
            <View>
